    ...
    <div class="min-h-screen bg-gray-100 p-10">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded shadow">
            ...
            <div class="mb-6">
                ...
                <select v-model="selectedClientId" class="w-full border rounded p-3">
            ...
            <div v-if="selectedClientWebsites.length">
                ...
                <ul class="list-disc ml-5 space-y-3">
                    <li v-for="website in selectedClientWebsites" :key="website.id">
...
<script setup>
    ...
    const selectedClientWebsites=computed(()=>{
        const client=props.clients.find(client => client.id==selectedClientId.value)
        return client ? client.websites:[];
    })
    const visitWebsite=(url)=>{
        const confirmed=confirm(`You are about to visit ${url}.Do you want to continue?`);
        if(confirmed){
